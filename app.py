...
def api_corpus_delete():
    ...
    try:
        ...
        # Use low-level collection for precise deletes
        col = db._collection
        def _del_where(where):
            try:
